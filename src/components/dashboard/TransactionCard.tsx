...
const TransactionCard:React.FC<TransactionCardProps> = ({transaction}) => {
  ...
  return (
    ...
    <div 
      className="n12 w-full items-center  bg-base-300  p-4  border rounded-[12px] shadow md:w-96">
    ...
    {description &&  <div className="des font-light h-6 overflow-hidden">{description}</div>}

        {createdAt && <p className="cat text-sm text-gray-500">{format(new Date(createdAt), "dd-MM-yyyy HH:mm")}</p>}
